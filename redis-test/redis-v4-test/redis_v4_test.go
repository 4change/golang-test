...
// 创建 redis 客户端
func createClient() *_redis.Client {
...
// String 操作
func stringOperation(client *_redis.Client) {
	...
	// 这里设置过期时间.
	err = client.Set("age", "20", 100 * time.Second).Err()
	if err != nil {
		panic(err)
	}
...
// list 操作
func listOperation(client *_redis.Client) {
...
// set 操作
func setOperation(client *_redis.Client) {
...
// hash 操作
func hashOperation(client *_redis.Client) {
...
// redis.v4 的连接池管理
func connectPool(client *_redis.Client) {
	wg := sync.WaitGroup{}
	wg.Add(10)
